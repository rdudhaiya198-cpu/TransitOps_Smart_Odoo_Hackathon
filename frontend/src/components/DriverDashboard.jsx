  ...
  return (
    <div className="flex-1 overflow-auto p-4 md:p-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          <h1 className="text-3xl font-extrabold tracking-tight">Drivers Registry</h1>
          <p className="text-slate-500 dark:text-slate-400 mt-1">Manage transport operators, safety scores, and licenses.</p>
        </div>
        <button
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl overflow-hidden shadow-sm">
        {loading ? (
          <div className="flex flex-col items-center justify-center p-16 gap-3">
            ...
            <span className="text-slate-500">Loading drivers database...</span>
          </div>
          ...
          <div className="flex flex-col items-center justify-center p-16 text-center">
            ...
            <h3 className="font-bold text-lg">No drivers found</h3>
            <p className="text-slate-500 dark:text-slate-400 mt-1 max-w-sm">No drivers match your search query. Add a new driver operator to get started.</p>
          </div>
        ) : (
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                {filteredDrivers.map((driver) => {
                  ...
                  return (
                    <tr key={driver.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/20 transition-all duration-150">
                      <td className="py-4 px-6">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <span className="text-[10px] bg-slate-100 dark:bg-slate-800 text-slate-400 px-1.5 py-0.5 rounded-md font-semibold tracking-wide">ID: {driver.id.slice(0, 8)}</span>
                          </div>
                        </div>
                      </td>
                      <td className="py-4 px-6">
                        <div className="space-y-1">
                          <p className="font-mono text-xs font-semibold text-slate-600 dark:text-slate-300">{driver.license_number}</p>
                          <div className="flex items-center gap-1.5">
                            <span className="text-[10px] text-slate-400 bg-slate-100 dark:bg-slate-800 px-1.5 py-0.5 rounded">{driver.license_category}</span>
                            <span className={`text-[10px] flex items-center gap-1 font-semibold ${isExpired ? 'text-red-400' : 'text-slate-500'}`}>
                              <Calendar className="w-3 h-3" /> Exp: {driver.license_expiry_date}
                              {isExpired && <span className="text-[9px] bg-red-500/10 text-red-500 px-1 rounded">Expired</span>}
                            </span>
                          </div>
                        </div>
                      </td>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="w-full max-w-lg bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            <div className="p-6 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
              <h2 className="text-xl font-extrabold">{editId ? 'Edit Operator' : 'Add New Operator'}</h2>
